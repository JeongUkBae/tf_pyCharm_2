...
gmaps_key = "AIzaSyAORVho3rqYhTAwMiLwnE-BBIyf16YGjdw"
...
for name in df_crime['관서명']:
    station_name.append('서울'+str(name[:-1])+'경찰서') #-1 = all의 의미
...
#print(df_crime) #  31개 관서명 존제

#금천경찰서는 관악구에 있어서 금천서를 찾아서 금천구라고 수동 작업
